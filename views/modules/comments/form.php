<?php echo form_open("comments/create/{$module}", 'id="create-comment"') ?>
	...
	<div class="form_name">
		<label for="name"><?php echo lang('comments:name_label') ?><span class="required">*</span>:
		<input type="text" name="name" id="name" maxlength="40" value="<?php echo $comment['name'] ?>">
		</label>
	</div>

	<div class="form_email">
		<label for="email"><?php echo lang('global:email') ?><span class="required">*</span>:
	...
	<div class="form_url">
		...
		<input type="text" name="website" id="website" maxlength="40" value="<?php echo $comment['website'] ?>">
	</div>
	...
	<div class="form_submit">
		<?php echo form_submit('submit', lang('comments:send_label'), 'class="small"') ?>
	</div>
